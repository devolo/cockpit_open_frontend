...
void main() {
  ...
  group('bool compareDevice(Device first, Device other)', () {
    ...
    test('Given_devicesWithDifferentVdslList_callCompareDevice_Then_returnFalse', () {
      ...
      var device2 = new Device("Magic 2 WiFi 2-1","powerline:ghn","Study Room","B8:BE:F4:31:96:AF","192.168.1.56","MT3082","1811269791000709","5.7.2","2021-03-05",false,true,true,"http://192.168.137.213/",true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full"],"1",[0,0],[1,0],[1,1]);
      var dataratePair3 = new DataratePair(double.parse("4.46453333333333319e+02").round(), double.parse("7.20000000000000018e+00").round());
