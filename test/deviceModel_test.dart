...
void main() {
  ...
  group('Device Constructor', () {
    ...
    test('Given__When_callDeviceConstructorWithUnderscoreVersion_Then_createDeviceWithCorrectVersion', () {
      ...
      var device = new Device("Magic 2 WiFi 2-1","powerline:ghn","Study Room","B8:BE:F4:31:96:AF","192.168.1.56","MT3082","1811269791000709","5.7.2_05.02.2020","",false,true,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"1",[0,0],[1,0],[1,1]);
    ...
    test('Given__When_callDeviceConstructorWithNormalVersion_Then_createDeviceWithCorrectVersion', () {
      ...
      var device = new Device("Magic 2 WiFi 2-1","powerline:ghn","Study Room","B8:BE:F4:31:96:AF","192.168.1.56","MT3082","1811269791000709","5.7.2","05.02.2020",false,true,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"1",[0,0],[1,0],[1,1]);
  ...
  group('factory Device.fromXML(XmlElement element, bool islocalDevice)', () {
    ...
    test('Given_deviceXML_When_callDevice.fromXML_Then_createDevice', () {
      ...
      var expectedDevice = new Device("Magic 2 WiFi 2-1","powerline:ghn","Study Room","B8:BE:F4:31:96:AF","192.168.1.56","MT3082","1811269791000709","5.7.2","2021-03-05",false,true,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"1",[0,0],[1,0],[1,1]);
  ...
  group('String toRealString()', () {
    ...
    test('Given Device When toRealString is called Then DeviceString returns', () {
      ...
      final dev = Device("Magic 1 WiFi 2-1","powerline:ghn", "devolo-045", "B8:BE:F4:00:08:B5", "192.168.178.137", "MT3064", "1807255601000045", "5.3.2", "2020-06-05", false, false, true, true, "siso_vdsl17a", ["siso_vdsl17a", "siso_full", "siso_vdsl35b"], "0",[0,0],[1,1],[0,0]);
