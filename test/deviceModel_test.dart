...
void main() {
  ...
  group('factory Device.fromXML(XmlElement element, bool islocalDevice)', () {
    ...
    test('Given_deviceXML_When_callDevice.fromXML_Then_createDevice', () {
      ...
      var expectedDevice = new Device("Magic 2 WiFi 2-1","Study Room","B8:BE:F4:31:96:AF","192.168.1.56","MT3082","1811269791000709","5.7.2","2021-03-05",false,true,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"1",[0,0],[1,0],[1,1]);
