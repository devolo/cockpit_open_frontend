...
void main() {
  ...
  group('Future<void> parseXML(String? rawData)',() {
    ...
    test('Given_DataHandObjectWithMockNetworklist_When_callParseXMLWithNetworkUpdateMessage_Then_setNetworkListInDataHandObject', () {
      ...
      var network = new NetworkList();
      var mockDevice = new Device("String type","powerline:ghn", "String name", "String mac", "String ip", "String MT", "String serialno", "String version", "String versionDate", false, false, true, true, "selectedVDSL", ["ja","nein"], "modeVDSL",[0,0],[1,0],[1,1]);
