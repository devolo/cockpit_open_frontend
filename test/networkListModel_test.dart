...
void main() {
  ...
  group('List<Device> getDeviceList()', () {
    ...
    test('Given_networkListObjectWithNetworkList_When_callGetDeviceListWithFalseNetworkIndex_Then_returnNetworkList[0]', () {
      ...
      var device1 = new Device("Magic 2 WiFi 2-1","powerline:ghn","Study Room","B8:BE:F4:31:96:AF","192.168.1.56","MT3082","1811269791000709","5.7.2","2021-03-05",false,true,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"1",[1,0],[1,1],[1,1]);
      ...
      var device2 = new Device("Magic 2 LAN 1-1","powerline:ghn","Gateway2","B8:BE:F4:0A:AE:B7","192.168.1.41","MT3005","1807044980025550","7.10.2.77","2021-04-01",true,false,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"1",[1,0],[1,1],[1,1]);
    ...
    test('Given_networkListObjectWithNetworkList_When_callGetDeviceList_Then_returnNetworkList', () {
      ...
      var device3 = new Device("Magic 2 WiFi 2-1","powerline:ghn","devolo-700","B8:BE:F4:31:96:8B","192.168.1.57","MT3082","1811269791000700","5.6.1","2020-10-23",false,false,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"0",[1,0],[1,1],[1,1]);
  ...
  group('List<List<Device>> getNetworkList()', () {
    ...
    test('Given_networkListObjectWithNetworkList_When_callGetNetworkList_Then_returnNetworkList', () {
      ...
      var device1 = new Device("Magic 2 WiFi 2-1","powerline:ghn","Study Room","B8:BE:F4:31:96:AF","192.168.1.56","MT3082","1811269791000709","5.7.2","2021-03-05",false,true,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"1",[0,0],[1,0],[1,1]);
      var dataratePair1 = new DataratePair(double.parse("4.46453333333333319e+02").round(), double.parse("7.20000000000000018e+00").round());
      var dataratePair2 = new DataratePair(double.parse("3.18240000000000009e+02").round(), double.parse("5.65706666666666592e+02").round());
      device1.speeds = {"B8:BE:F4:0A:AE:B7": dataratePair1, "B8:BE:F4:31:96:8B": dataratePair2};

      var device2 = new Device("Magic 2 LAN 1-1","powerline:ghn","Gateway2","B8:BE:F4:0A:AE:B7","192.168.1.41","MT3005","1807044980025550","7.10.2.77","2021-04-01",true,false,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"1",[1,0],[0,0],[1,1]);
      var dataratePair3 = new DataratePair(double.parse("2.98080000000000041e+02").round(), double.parse("8.28853333333333353e+02").round());
      var dataratePair4 = new DataratePair(double.parse("2.94719999999999970e+02").round(), double.parse("3.70133333333333326e+02").round());
      device2.speeds = {"B8:BE:F4:31:96:8B": dataratePair3, "B8:BE:F4:31:96:AF": dataratePair4};

      var device3 = new Device("Magic 2 WiFi 2-1","powerline:ghn","devolo-700","B8:BE:F4:31:96:8B","192.168.1.57","MT3082","1811269791000700","5.6.1","2020-10-23",false,false,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"0",[1,0],[1,1],[0,0]);
      var dataratePair5 = new DataratePair(double.parse("8.28853333333333353e+02").round(), double.parse("2.98080000000000041e+02").round());
      var dataratePair6 = new DataratePair(double.parse("5.65706666666666592e+02").round(), double.parse("3.18240000000000009e+02").round());
      device3.speeds = {"B8:BE:F4:0A:AE:B7": dataratePair5, "B8:BE:F4:31:96:AF": dataratePair6};
  ...
  group('List<Device> getAllDevicesFilteredByState()', () {
    ...
    test('Given_networkListObjectWithNetworkListAndUpdateList_When_callGetAllDevicesFilteredByState_Then_returnFilteredDeviceList', () {
      ...
      var device4 = new Device("dLAN pro 1200+ WiFi ac","powerline:hpav","devolo-700","B8:BE:F4:31:96:8A","192.168.1.57","MT3082","1811269791000700","5.6.1","2020-10-23",false,false,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"0",[0,0],[1,0],[1,1]);
      var device5 = new Device("unknowntype","powerline:hpav","devolo-700","B8:BE:F4:31:96:8C","192.168.1.57","MT3082","1811269791000700","5.6.1","2020-10-23",false,false,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"0",[1,0],[0,0],[1,1]);
  ...
  group('List<Device> getPivotDevice()', () {
    ...
    test('Given_networkListObjectWithNetworkListWithoutPivotDevice_When_callGetPivotDevice_Then_returnNoDevice', () {
      ...
      var device2 = new Device("Magic 2 LAN 1-1","powerline:ghn","Gateway2","B8:BE:F4:0A:AE:B7","192.168.1.41","MT3005","1807044980025550","7.10.2.77","2021-04-01",false,false,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"1",[1,0],[0,0],[1,1]);
      var dataratePair3 = new DataratePair(double.parse("2.98080000000000041e+02").round(), double.parse("8.28853333333333353e+02").round());
      var dataratePair4 = new DataratePair(double.parse("2.94719999999999970e+02").round(), double.parse("3.70133333333333326e+02").round());
      device2.speeds = {"B8:BE:F4:31:96:8B": dataratePair3, "B8:BE:F4:31:96:AF": dataratePair4};
  ...
  group('List<Device> getLocalDevice()', () {
    ...
    test('Given_networkListObjectWithNetworkListWithoutLocalDevice_When_callGetLocalDevice_Then_returnNoDevice', () {
      ...
      var device1 = new Device("Magic 2 WiFi 2-1","powerline:ghn","Study Room","B8:BE:F4:31:96:AF","192.168.1.56","MT3082","1811269791000709","5.7.2","2021-03-05",false,false,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"1",[0,0],[1,0],[1,1]);
      var dataratePair1 = new DataratePair(double.parse("4.46453333333333319e+02").round(), double.parse("7.20000000000000018e+00").round());
      var dataratePair2 = new DataratePair(double.parse("3.18240000000000009e+02").round(), double.parse("5.65706666666666592e+02").round());
      device1.speeds = {"B8:BE:F4:0A:AE:B7": dataratePair1, "B8:BE:F4:31:96:8B": dataratePair2};
  ...
  group('List<Device> getLocalDevices()', () {
    ...
    test('Given_networkListObjectWithNetworkList_When_callGetLocalDevice_Then_returnLocalDevice', () {
      ...
      var device4 = new Device("Magic 2 WiFi 2-1","powerline:ghn","devolo-700","B8:BE:F4:31:96:8B","192.168.1.57","MT3082","1811269791000700","5.6.1","2020-10-23",false,true,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"0",[1,0],[1,1],[0,0]);
  ...
  group('List<String> getNetworkName(networkIndex))', () {
    ...
    test('Given_networkListObjectWithNetworkList_When_callGetNetworkName_Then_returnNetworkName', ()
    {
      ...
      var device4 = new Device("dLAN pro 1200+ WiFi ac","powerline:ghn","devolo-700","B8:BE:F4:31:96:8B","192.168.1.57","MT3082","1811269791000700","5.6.1","2020-10-23",false,false,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"0",[0,0],[1,0],[1,1]);
      var device5 = new Device("unknowntype","powerline:ghn","devolo-700","B8:BE:F4:31:96:8B","192.168.1.57","MT3082","1811269791000700","5.6.1","2020-10-23",false,false,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"0",[1,0],[0,0],[1,1]);

      var device6 = new Device("Magic 2 LAN 1-1","powerline:ghn","Gateway2","B8:BE:F4:0A:AE:B9","192.168.1.134","MT3005","1807044980025550","7.10.2.77","2021-04-01",true,true,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"1",[1,0],[0,0],[1,1]);
  ...
  group('void setDeviceList(List<Device> devList)', () {
    ...
    test('Given_networkListObjectWithNetworkList_When_callSetDeviceList_Then_setDeviceListAtSelectedIndex', () {
      ...
      var device4 = new Device("testDevice","powerline:ghn","devolo-700","B8:BE:F4:31:96:8B","192.168.1.57","MT3082","1811269791000700","5.6.1","2020-10-23",false,false,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"0",[0,0],[1,0],[1,1]);
  ...
  group('Device getDeviceByMac(String mac)',(){
    test('Given_networkListObjectWithNetworkList_When_callGetDeviceByMac_Then_returnDevice',(){
      ...
      var device2 = new Device("Magic 2 LAN 1-1","powerline:ghn","Gateway2","B8:BE:F4:0A:AE:B7","192.168.1.41","MT3005","1807044980025550","7.10.2.77","2021-04-01",true,false,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"1",[1,0],[1,1],[0,0]);
      var dataratePair3 = new DataratePair(double.parse("2.98080000000000041e+02").round(), double.parse("8.28853333333333353e+02").round());
      var dataratePair4 = new DataratePair(double.parse("2.94719999999999970e+02").round(), double.parse("3.70133333333333326e+02").round());
      device2.speeds = {"B8:BE:F4:31:96:8B": dataratePair3, "B8:BE:F4:31:96:AF": dataratePair4};

      var device3 = new Device("Magic 2 WiFi 2-1","powerline:ghn","devolo-700","B8:BE:F4:31:96:8B","192.168.1.57","MT3082","1811269791000700","5.6.1","2020-10-23",false,false,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"0",[1,0],[0,0],[1,1]);

      var dataratePair5 = new DataratePair(double.parse("8.28853333333333353e+02").round(), double.parse("2.98080000000000041e+02").round());
      var dataratePair6 = new DataratePair(double.parse("5.65706666666666592e+02").round(), double.parse("3.18240000000000009e+02").round());
      device3.speeds = {"B8:BE:F4:0A:AE:B7": dataratePair5, "B8:BE:F4:31:96:AF": dataratePair6};

      var device4 = new Device("testDevice","powerline:ghn","devolo-700","B8:BE:F4:31:96:8C","192.168.1.57","MT3082","1811269791000700","5.6.1","2020-10-23",false,false,true,true,"mimo_vdsl17a",["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"],"0",[0,0],[1,0],[1,1]);
  ...
  group('String selectedNetworkListToRealString()', () {
    ...
    test('Given networkList When selectedNetworkListToRealString is called Then NetworkString returns', () {
      ...
      final dev1 = Device("Magic 2 LAN 1-1", "powerline:ghn","devoloLAN", "30:D3:2D:EE:8D:A1", "192.168.178.139", "MT2999", "1806154350000340", "7.8.5.47", "2020-06-05", true, true, true, true, "mimo_vdsl17a", ["mimo_vdsl17a", "siso_full", "siso_vdsl17a", "siso_vdsl35b", "mimo_full", "mimo_vdsl35b"], "0",[0,0],[1,0],[1,1]);
      var dataratePair1 = new DataratePair(double.parse("4.46453333333333319e+02").round(), double.parse("7.20000000000000018e+00").round());
      var dataratePair2 = new DataratePair(double.parse("3.18240000000000009e+02").round(), double.parse("5.65706666666666592e+02").round());
      dev1.speeds = {"B8:BE:F4:00:0C:07": dataratePair1};

      final dev2 = Device("Magic 1 WiFi 2-1", "powerline:ghn","AP-Unten2", "B8:BE:F4:00:0C:07", "192.168.178.136", "MT3064", "1807255601000215", "5.8.0.N1077", "2021-04-06", false, false, true, true, "siso_vdsl17a", ["siso_vdsl17a", "siso_full", "siso_vdsl35b"], "1",[1,0],[0,0],[1,1]);
      var dataratePair3 = new DataratePair(double.parse("2.98080000000000041e+02").round(), double.parse("8.28853333333333353e+02").round());
      var dataratePair4 = new DataratePair(double.parse("2.94719999999999970e+02").round(), double.parse("3.70133333333333326e+02").round());
